...
B * See the GNU General Public License for more details.
 *
...
#define TARGET_BOARD_IDENTIFIER "FOSS"
#define USBD_PRODUCT_STRING     "FOSSF4ELRS"
...
#define RX_SPI_EXTI_PIN        PC15
#define RX_EXPRESSLRS_SPI_RESET_PIN      PB9
#define RX_EXPRESSLRS_SPI_BUSY_PIN       PA3
